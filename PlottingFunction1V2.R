#' Visualization of a initial RE meta-tree with terminal node frequency coloring
#'
...
#' appear as terminal nodes in the amount of iterations given.
...
#' @import gridExtra
#' @export
plot.PV.TN <- function(x, iter = 10, c.pruning = 0){
